...
def jsonld_blogposting(title, desc, path):
    data = {
        ...
        "inLanguage": "ko-KR",
        "author": {"@type": "Organization", "name": f"{SITE_NAME} 운영팀"},
...
# 글 1편: slug, cat, eyebrow, title, h1, desc, lead, secs[(소제목, html)], faq, related[(href,label)]
ARTICLES = [
    {"slug": "guro-massage-first-guide", "cat": "guide",
     "title": "구로 출장마사지·홈타이 처음 이용 가이드 | 예약부터 방문까지",
     "h1": "구로 출장마사지·홈타이, 처음이라면 이렇게 이용하세요",
     "desc": "구로 출장마사지·홈타이가 처음인 분을 위한 단계별 이용 가이드입니다. 예약 방법, 코스 선택, 방문 준비, 주의사항을 한 번에 정리했습니다.",
     "lead": "방문 관리가 처음이면 절차가 막막하게 느껴질 수 있습니다. 예약부터 방문, 관리 후까지 순서대로 정리했습니다.",
     "secs": [
        ("출장마사지·홈타이란 무엇인가요",
         "<p>출장마사지와 홈타이는 모두 관리사가 이용자의 가정·숙소·오피스텔 등으로 직접 방문해 진행하는 "
         "<strong>방문 건강관리</strong>를 가리킵니다. 매장을 찾아가는 대신 익숙한 공간에서 이완·휴식 중심의 관리를 "
         "받을 수 있어, 이동이 부담스럽거나 관리 후 바로 쉬고 싶은 분께 적합합니다. 두 표현은 받는 장소와 상황의 "
         "차이일 뿐 본질은 같습니다.</p>"
         "<p>구로88마사지는 구로구 전지역을 대상으로 안내하며, 지역·지하철역·테마를 각각 분리해 안내합니다. 본 "
         "서비스는 의료 행위가 아닌 이완·휴식 목적의 건강관리이며, 만 19세 이상 성인을 대상으로 합니다.</p>"),
        ("1단계 — 예약 전 준비",
         "<p>예약 전에 네 가지를 정리해 두면 상담이 빠릅니다. 첫째 방문 받을 <strong>정확한 주소</strong>와 출입 방법, "
         "둘째 희망 날짜·시간과 대체 시간, 셋째 원하는 코스(60·90·120분)와 테마, 넷째 인원입니다. 지역은 "
         "<a href='/guro-gu/'>지역별 안내</a>의 대표 동, 역은 <a href='/guro-gu/stations/'>지하철역별 안내</a>를 "
         "기준으로 말씀하시면 됩니다.</p>"),
        ("2단계 — 코스와 테마 선택",
         "<p>코스 시간은 가볍게는 60분, 전신을 충분히 이완하려면 90분, 깊은 휴식은 120분이 기준입니다. 관리 유형은 "
         "부드러운 <a href='/theme/swedish/'>스웨디시</a>, 향과 함께하는 <a href='/theme/aroma-therapy/'>아로마테라피</a>, "
         "근육 회복 중심의 <a href='/theme/sports-massage/'>스포츠·경락</a> 등에서 고릅니다. 처음이라면 90분 스웨디시가 "
         "무난합니다. 결정이 어렵다면 <a href='/course/guide/'>코스 선택 가이드</a>를 참고하세요.</p>"),
        ("3단계 — 방문과 관리 진행",
         "<p>예약이 확정되면 약속 시간에 관리사가 방문합니다. 집에는 관리에 적합한 편평하고 조용한 공간만 있으면 "
         "충분하며 별도 준비물은 필요하지 않습니다. 원하는 강도(약하게·보통·강하게)와 집중 부위를 미리 말씀하시면 "
         "컨디션에 맞춰 시작합니다. 향·오일에 민감하거나 피하고 싶은 부위가 있으면 시작 전에 알려주세요.</p>"),
        ("4단계 — 관리 후 주의사항",
         "<p>관리 후에는 몸이 이완된 상태이므로 격한 운동이나 음주는 피하고 따뜻한 물로 수분을 보충한 뒤 충분히 "
         "쉬는 것이 좋습니다. 자세한 내용은 <a href='/guide/aftercare/'>관리 후 주의사항</a>에서 확인할 수 있습니다. "
         "다음 이용 시에는 같은 절차로 더 빠르게 예약하실 수 있습니다.</p>")],
     "faq": [
        ("정말 집으로 방문하나요?", "예. 가정·숙소·오피스텔 등 요청하신 위치로 방문합니다. 정확한 방문 가능 여부는 예약 시 주소와 시간으로 확인합니다."),
        ("준비물이 필요한가요?", "별도 준비물은 없습니다. 편평하고 조용한 공간만 있으면 되고, 원하면 가볍게 샤워 후 받으셔도 됩니다."),
        ("처음인데 강도가 걱정돼요.", "약하게·보통·강하게로 조절할 수 있으니 예약 시 처음임을 알려주시면 편안하게 진행합니다.")],
    ...
    {"slug": "swedish-vs-aroma", "cat": "course-theme",
     ...
     "secs": [
        ("스웨디시의 특징",
         ...
         "대표적인 전신 이완 관리입니다. 일정한 압으로 어깨·등·다리를 부드럽게 풀어 몸 전체의 긴장을 가라앉히는 데 "
         "초점이 있습니다. 자극이 과하지 않아 방문 관리를 처음 이용하는 분께도 무난합니다.</p>"
         "<p>유럽에서 정립된 오일 마사지의 기본 형태로, 손바닥과 손가락을 넓게 사용해 혈류를 따라 부드럽게 밀어주는 "
         "것이 특징입니다. 강한 통증보다는 시원하고 나른한 이완감을 주기 때문에, 격한 자극이 부담스러운 분이나 전신을 "
         "골고루 풀고 싶은 분이 선택하기 좋습니다. 압의 세기는 약하게부터 강하게까지 조절할 수 있어, 컨디션에 맞춰 "
         "편안하게 받을 수 있습니다.</p>"),
        ("아로마테라피의 특징",
         "<p><a href='/theme/aroma-therapy/'>아로마테라피</a>는 향 오일을 사용해 후각과 촉각을 함께 자극하는 관리입니다. "
         "손길로 근육을 풀어주는 동시에 은은한 향으로 심리적인 이완을 돕기 때문에, 단순한 피로 해소를 넘어 스트레스 "
         "해소와 분위기 있는 휴식을 함께 원하는 분께 잘 어울립니다.</p>"),
        ("어떤 차이가 있나요",
         "<p>가장 큰 차이는 ‘향의 활용’입니다. 스웨디시가 손기술 중심의 신체 이완에 집중한다면, 아로마테라피는 향이 "
         "더해져 심신을 함께 가라앉힙니다. 압의 세기나 전신을 다루는 흐름은 비슷하지만, 끝난 뒤의 느낌은 아로마 쪽이 "
         "조금 더 차분하고 나른한 편입니다.</p>"),
        ("이렇게 선택하세요",
         "<p>전반적인 근육 피로를 풀고 가볍게 휴식하고 싶다면 스웨디시, 스트레스가 쌓였거나 잠들기 전 분위기 있는 "
         "이완을 원한다면 아로마테라피를 권합니다. 향에 민감하다면 예약 시 미리 알려주세요. 시간은 두 관리 모두 90분이 "
         "무난하며, <a href='/course/price/'>가격 안내</a>에서 기준 요금을 확인할 수 있습니다.</p>"),
        ("함께 고려하면 좋은 관리",
         "<p>잠을 깊게 자고 싶다면 <a href='/theme/sleep-available/'>수면 가능</a> 관리를, 특정 부위가 심하게 뭉쳤다면 "
         "<a href='/theme/sports-massage/'>스포츠·경락</a>을 함께 고려해 보세요. 테마는 코스 시간과 함께 선택하며, "
    ...
    {"slug": "office-worker-recovery", "cat": "tips",
     ...
     "secs": [
        ("앉아서 일하는 몸에 쌓이는 피로",
         ...
         "이어지면 목과 어깨, 허리 주변 근육이 뭉치고 혈류가 정체되어 피로가 쌓입니다. 퇴근 후에도 풀리지 않는 "
         "묵직함이 반복된다면 정기적인 이완 관리가 도움이 됩니다.</p>"
         "<p>특히 모니터를 향해 고개를 숙인 자세가 길어지면 목 뒤와 승모근에 긴장이 집중되고, 마우스를 쓰는 팔과 "
         "손목에도 피로가 누적됩니다. 운동이나 스트레칭으로 풀어주지 않으면 만성적인 결림으로 이어지기 쉽습니다. "
         "이런 누적 피로는 한 번의 강한 자극보다 꾸준한 이완 관리로 풀어주는 편이 몸에 부담이 적습니다.</p>"),
        ("어떤 관리가 잘 맞을까",
         "<p>전반적인 피로 해소가 목적이라면 <a href='/theme/swedish/'>스웨디시</a>로 전신을 고르게 풀고, 특정 부위 "
         "뭉침이 심하다면 <a href='/theme/sports-massage/'>스포츠·경락</a>으로 어깨·허리를 집중적으로 풀어주는 것이 "
         "좋습니다. 종일 서서 일했다면 <a href='/theme/foot-massage/'>발마사지</a>로 하체 피로를 함께 다스릴 수 "
         "있습니다.</p>"),
        ("퇴근 후 방문 관리의 장점",
         "<p>방문 관리는 매장까지 이동할 필요가 없어 퇴근 후 바로 집에서 받을 수 있습니다. 관리 후 외출 없이 곧장 "
         "휴식과 수면으로 이어지므로 회복 효율이 높습니다. <a href='/guro-gu/stations/gurodigital-station/'>구로디지털단지역</a>·"
         "<a href='/guro-gu/guro-dong/'>구로동</a> 생활권은 저녁 시간대 문의가 많으니 미리 예약하면 원하는 시간을 잡기 "
         "쉽습니다.</p>"),
        ("관리 효과를 오래 유지하려면",
         "<p>관리 후에는 따뜻한 물로 수분을 보충하고 충분히 쉬는 것이 좋습니다. 평소에는 한 시간에 한 번 정도 일어나 "
         "가볍게 스트레칭하고, 모니터 높이와 의자 자세를 점검하면 뭉침을 줄일 수 있습니다. 주기적으로 관리를 받으면 "
         "누적 피로가 쌓이는 것을 막는 데 도움이 됩니다.</p>"),
        ("예약 전 확인",
         "<p>방문 전 정확한 주소와 출입 방법, 조용한 공간을 확인해 주세요. 코스는 60·90·120분 중 선택하며 처음에는 "
         "90분이 무난합니다. 기준 요금은 <a href='/course/price/'>가격 안내</a>에서 확인할 수 있습니다.</p>")],
     "faq": [
    ...
    {"slug": "hometai-prepare-guide", "cat": "guide",
     ...
     "secs": [
        ("관리 공간 확보",
         ...
         "있으면 충분합니다. 바닥이나 침대 주변에 충분한 공간을 비워 두고, 관리에 방해되는 물건은 미리 정리해 두면 좋습니다. "
         "자세한 준비는 <a href='/guide/prepare/'>방문 전 준비사항</a>에서도 확인할 수 있습니다.</p>"
         "<p>특별한 장비를 따로 둘 필요는 없습니다. 평소 생활하는 방이나 거실에 사람이 누울 수 있는 정도의 공간만 "
         "마련하면 되고, 매트가 필요한 경우 관리사가 준비해 옵니다. 다만 바닥이 너무 차갑거나 주변이 어수선하면 "
         "이완에 방해가 될 수 있으니, 난방과 정돈만 가볍게 신경 써 두면 한결 편안한 관리가 됩니다.</p>"),
        ("출입 방법 공유",
         "<p>아파트·오피스텔은 공동현관과 엘리베이터 출입 절차가 건물마다 다릅니다. 예약 시 동·호수와 함께 공동현관 "
         "비밀번호나 출입 방법, 방문자 안내 절차를 알려주시면 도착 후 헤매지 않고 정시에 진행할 수 있습니다. 숙소라면 "
         "객실 번호와 연락 가능한 번호를 함께 알려주세요.</p>"),
        ("주차와 이동 동선",
         "<p>차량 방문이 필요한 경우 주차 가능 여부와 위치를 미리 확인해 두면 좋습니다. 주택가 골목은 주차가 어려운 "
         "경우가 있으니, 인근 주차장이나 방문자 주차 공간을 안내해 주시면 도움이 됩니다. 이동 시간을 고려해 약속 시간보다 "
         "조금 여유를 두는 것도 방법입니다.</p>"),
        ("사전에 공유하면 좋은 정보",
         "<p>향이나 오일에 민감하거나 알레르기가 있다면 예약 시 알려주세요. 특별히 집중하고 싶은 부위나 피하고 싶은 "
         "부위, 통증이 있는 곳이 있다면 미리 공유하면 더 안전하고 만족스러운 관리가 됩니다. 원하는 강도도 함께 말씀해 "
         "주시면 좋습니다.</p>"),
        ("방문 당일 체크리스트",
    ...
    {"slug": "hygiene-safety-checklist", "cat": "guide",
     ...
     "secs": [
        ("위생 관리 기준",
         ...
         "진행합니다. 이용자도 관리 공간을 깨끗하게 정돈하고 환기해 두면 더 쾌적하게 받을 수 있습니다. 자세한 운영 "
         "기준은 <a href='/guide/safety/'>위생 및 안전 기준</a>에서 확인할 수 있습니다.</p>"
         "<p>특히 피부에 직접 닿는 용품과 오일은 청결 관리가 중요합니다. 사용 전후 위생을 점검하고, 이용자의 피부 "
         "상태나 알레르기 여부를 미리 확인해 진행하면 더 안전합니다. 향이나 오일에 민감하다면 예약 단계에서 알려주시는 "
         "것이 가장 좋은 위생·안전 대비입니다.</p>"),
        ("예약 정보·개인정보 보호",
         "<p>예약 과정에서 제공하는 연락처와 주소 등은 예약 접수·확인 목적에만 사용되며 보호됩니다. 자세한 내용은 "
         "<a href='/privacy/'>개인정보처리방침</a>에 정리되어 있습니다. 이용자도 신뢰할 수 있는 경로로 예약하고, "
         "불필요하게 개인정보를 노출하지 않도록 주의하는 것이 좋습니다.</p>"),
        ("이용자가 확인하면 좋은 점",
         "<p>이용 전 서비스 범위와 코스, 금액을 명확히 확인하세요. 표시 요금 외 부당한 추가 요구는 정상적인 운영이 "
         "아닙니다. 또한 본 서비스는 의료 행위가 아닌 이완·휴식 목적의 건강관리이므로, 통증이 심하거나 특정 질환이 "
         "있다면 무리한 관리보다 전문의 진료를 먼저 권합니다.</p>"),
        ("제공하지 않는 행위",
         "<p>구로88마사지는 불법·퇴폐 행위를 일절 제공하지 않으며, 만 19세 이상 성인을 대상으로 합니다. 관리사에 대한 "
         "폭언·폭력·성적 요구, 사전 합의되지 않은 촬영 등은 금지됩니다. 자세한 기준은 "
         "<a href='/guide/forbidden/'>금지행위 안내</a>에서 확인할 수 있습니다.</p>"),
        ("안전한 이용을 위한 마무리",
         "<p>안전은 운영자와 이용자가 함께 만드는 것입니다. 정확한 정보로 예약하고, 서로를 존중하며, 기준을 지키는 "
         "이용이 가장 좋은 관리로 이어집니다. 궁금한 점은 언제든 <a href='/customer/'>고객센터</a>로 문의해 주세요.</p>")],
     "faq": [
        ("용품은 위생적으로 관리되나요?", "예. 청결한 관리 용품과 위생적인 절차로 진행합니다."),
        ("개인정보는 어떻게 보호되나요?", "예약 정보와 개인정보는 개인정보처리방침에 따라 예약 목적에만 사용·보호됩니다."),
        ("불법 요구를 받으면 어떻게 하나요?", "본 서비스는 그런 행위를 제공하지 않습니다. 부당한 요구는 응하지 않으셔도 됩니다.")],
    ...
    {"slug": "guro-station-area-tips", "cat": "area-station",
     ...
     "secs": [
        ("환승 거점 — 신도림·온수·대림역",
         ...
         "방문이 수월합니다. 유동인구가 많은 만큼 저녁 시간대 문의가 몰리므로 미리 예약하는 것이 좋습니다. 대림역은 "
         "영등포 방면과 혼동되기 쉬우니 구로구 방향임을 분명히 해 주세요.</p>"
         "<p>환승역 주변은 오피스텔과 숙박시설이 많아 출장·여행 중 숙소 방문 문의도 적지 않습니다. 숙소에서 받을 "
         "때는 객실 번호와 출입 방법, 연락 가능한 번호를 함께 알려주시면 도착 후 지체 없이 진행할 수 있습니다. "
         "건물 보안 출입이 까다로운 곳은 방문자 안내 절차를 미리 확인해 두는 것이 좋습니다.</p>"),
        ("업무 중심 — 구로·구로디지털단지역",
        ...
        ("역이 아니라 ‘주소’가 기준",
         ...
         "따라 이동 시간이 다르므로, 예약 시 도로명 주소나 건물명을 알려주시면 더 정확합니다. 구로88마사지는 ‘역 이름 + "
         "테마’를 조합한 페이지를 따로 두지 않고 역 단위로만 안내합니다.</p>"),
        ("역세권 이용 마무리 팁",
         "<p>약속 장소를 역 기준으로 잡았다면 <a href='/guro-gu/stations/'>지하철역별 안내</a>에서 해당 역의 인근 "
         "생활권을, 거주지 기준이라면 <a href='/guro-gu/'>지역별 안내</a>에서 대표 동을 확인하면 편리합니다.</p>")],
     "faq": [
    ...
    {"slug": "couple-home-care", "cat": "course-theme",
     ...
     "secs": [
        ("커플·가족 관리란",
         ...
         "이용에도 잘 맞습니다. 익숙한 집에서 받으니 편안함이 더합니다.</p>"
         "<p>혼자 받을 때와 달리 함께 받으면 같은 시간에 둘 다 휴식을 누릴 수 있어, 일정 맞추기가 수월하고 분위기도 "
         "한층 편안해집니다. 한 분은 스웨디시, 다른 한 분은 아로마처럼 각자 다른 테마를 선택할 수도 있습니다. 두 자리를 "
         "둘 수 있는 공간만 확보되면 거실이나 넓은 방에서 무리 없이 진행할 수 있습니다.</p>"),
        ("어떤 분께 잘 맞나요",
         "<p>신혼·가족 세대가 많은 <a href='/guro-gu/cheonwang-dong/'>천왕동</a>, "
         "<a href='/guro-gu/hang-dong/'>항동</a> 같은 신주거 생활권에서 특히 문의가 많습니다. 함께 받는 시간을 충분히 "
         "누리려면 90분 이상을 권하며, 분위기 있는 휴식을 원한다면 <a href='/theme/aroma-therapy/'>아로마테라피</a> 구성이 "
         "잘 어울립니다.</p>"),
        ("예약 시 알려주실 정보",
         "<p>동시에 받기 위해서는 인원과 희망 시간을 미리 알려주셔야 배정이 수월합니다. 두 분이 같은 관리를 원하는지, "
         "각자 다른 테마를 원하는지도 함께 말씀해 주시면 좋습니다. 공간이 충분한지(두 자리 확보 가능 여부)도 미리 "
         "확인해 두세요.</p>"),
        ("기념일을 위한 작은 팁",
         "<p>기념일에는 예약이 몰릴 수 있으니 날짜가 정해지면 일찍 예약하는 것이 좋습니다. 관리 전후로 조명을 낮추고 "
         "조용한 환경을 만들어 두면 분위기가 한결 살아납니다. 관리 후에는 무리한 일정보다 함께 쉬는 시간을 두는 것을 "
         "권합니다.</p>"),
        ("코스·요금 확인",
         "<p>인원과 코스 구성에 따라 안내가 달라지므로, 정확한 금액과 가능 여부는 예약 상담에서 확인됩니다. 기준 요금은 "
         "<a href='/course/price/'>가격 안내</a>, 코스 구성은 <a href='/course/couple/'>커플·가족 방문 관리</a>를 "
         "참고하세요.</p>")],
     "faq": [
    ...
    {"slug": "sleep-aroma-routine", "cat": "tips",
     ...
     "secs": [
        ("왜 잠들기 어려울까",
         ...
         "소리, 늦은 시간의 활동도 수면을 방해합니다. 잠들기 전 몸과 마음의 긴장을 천천히 가라앉히는 과정이 필요한 "
         "이유입니다.</p>"
         "<p>특히 어깨와 목이 뻣뻣하게 굳어 있으면 누워도 편안한 자세를 찾기 어려워 자주 뒤척이게 됩니다. 머릿속이 "
         "복잡해 생각이 멈추지 않는 것도 흔한 원인입니다. 이럴 때는 근육의 긴장을 풀어주는 신체적 이완과, 향과 차분한 "
         "흐름으로 마음을 가라앉히는 심리적 이완을 함께 시도하면 잠드는 데 도움이 됩니다.</p>"),
        ("수면을 돕는 관리",
         "<p><a href='/theme/sleep-available/'>수면 가능</a> 관리는 자극을 낮추고 느린 호흡에 맞춘 차분한 흐름으로 "
         "진행해 자연스럽게 잠들 수 있도록 돕습니다. 향이 더해진 <a href='/theme/aroma-therapy/'>아로마테라피</a>와 "
         "함께 구성하면 후각과 촉각이 동시에 이완을 유도해 효과적입니다.</p>"),
        ("관리 효과를 높이는 환경",
         "<p>관리 전후로 조명을 낮추고 조용한 환경을 만들어 두면 효과가 더 좋습니다. 잠들기 직전에 받을 수 있도록 늦은 "
         "저녁 시간대로 예약하는 것을 권합니다. 개봉동·궁동처럼 조용한 주거 생활권에서 특히 수면 중심 관리 문의가 "
         "많습니다.</p>"),
        ("잠들기 전 생활 루틴",
         "<p>관리와 함께 생활 습관도 점검해 보세요. 잠들기 한두 시간 전에는 강한 빛과 화면을 줄이고, 카페인과 늦은 "
         "음주를 피하며, 따뜻한 물로 가볍게 몸을 데우면 수면에 도움이 됩니다. 일정한 시간에 잠자리에 드는 것도 "
         "중요합니다.</p>"),
        ("예약 시 참고",
         "<p>수면을 돕는 흐름을 원하시면 예약 시 ‘수면 중심’으로 요청해 주세요. 향에 민감하다면 향의 종류와 농도를 "
         "조절할 수 있습니다. 기준 요금은 <a href='/course/price/'>가격 안내</a>에서 확인할 수 있습니다.</p>")],
     "faq": [
    ...
    {"slug": "course-time-guide", "cat": "course-theme",
     ...
     "secs": [
        ("60분 — 가볍게 푸는 시간",
         ...
         "가장 불편한지 알려주시는 것이 좋습니다. 그러면 한정된 시간을 효율적으로 써서 만족도를 높일 수 있습니다. "
         "‘일단 어떤 느낌인지 경험해 보고 싶다’는 분께 첫 코스로 권할 만합니다.</p>"),
        ("90분 — 가장 무난한 선택",
         "<p>90분 코스는 전신을 충분히 이완하면서도 부담이 크지 않아 가장 많이 선택되는 시간입니다. 아로마를 포함한 "
         "추천 구성으로 운영되며, 처음 이용하는 분께도 무난합니다. 어느 테마와도 잘 어울려 ‘무엇을 고를지 모르겠다면 "
         "90분’이라 할 만합니다. 기본 요금은 120,000원입니다.</p>"),
        ("120분 — 깊은 휴식과 집중 관리",
         "<p>120분 코스는 전신을 천천히 다루며 특정 부위까지 집중적으로 풀고 싶을 때 적합합니다. 깊은 휴식과 프리미엄 "
         "케어를 원하거나, 누적된 피로를 충분히 풀고 싶을 때 권합니다. 커플·가족이 함께 받을 때도 여유로운 시간이 "
         "됩니다. 기본 요금은 150,000원입니다.</p>"),
        ("목적별로 고르기",
         "<p>가볍게 컨디션 관리라면 60분, 전반적인 이완과 휴식이라면 90분, 깊은 회복과 집중 관리라면 120분이 기준입니다. "
         "운동 후 회복이나 심한 뭉침이 있다면 시간이 길수록 충분히 풀 수 있습니다. 결정이 어렵다면 "
         "<a href='/course/guide/'>코스 선택 가이드</a>를 참고하세요.</p>"),
        ("테마와 함께 선택",
         "<p>코스 시간은 원하는 테마와 함께 정합니다. 즉 ‘무엇을(테마) 얼마나 오래(시간)’ 받을지를 함께 고르는 "
         "방식입니다. 전체 요금 기준은 <a href='/course/price/'>가격 안내</a>에서 확인하고, 정확한 금액은 예약 상담에서 "
         "안내받으세요.</p>")],
     "faq": [
    ...
    {"slug": "guro-life-area-guide", "cat": "area-station",
     ...
     "secs": [
        ...
        ("주거 중심 생활권",
         ...
         "<a href='/guro-gu/oryu-dong/'>오류동</a>은 안양천변 대단지와 주택가가 넓게 자리한 주거 생활권입니다. 가족 단위 "
         "이용과 가정 방문 홈타이, 수면을 돕는 저자극 관리 선호가 두드러집니다.</p>"),
        ("신주거·한적한 생활권",
         "<p><a href='/guro-gu/cheonwang-dong/'>천왕동</a>, <a href='/guro-gu/hang-dong/'>항동</a>, "
         "<a href='/guro-gu/gung-dong/'>궁동</a>은 신주거단지와 녹지가 많은 비교적 한적한 생활권입니다. 커플·가족 관리와 "
         "아로마·수면 중심의 편안한 휴식 문의가 많습니다.</p>"),
        ("숫자 동은 대표 동으로",
         "<p>구로1~5동, 고척1~2동, 개봉1~3동, 오류1~2동처럼 숫자로 나뉜 행정동은 별도 페이지 없이 대표 동에서 통합 "
         "안내합니다. 어느 숫자 동에 거주하시든 해당 대표 동 페이지를 기준으로 문의하시면 됩니다. 가리봉동·온수동도 각 "
         "생활권 페이지에서 안내합니다.</p>"),
        ("내 생활권 찾아보기",
         "<p>거주·방문하시는 동의 특징과 인근 역, 자주 찾는 테마는 <a href='/guro-gu/'>지역별 안내</a>에서 동별로 확인할 "
         "수 있습니다. 역 기준으로 찾는다면 <a href='/guro-gu/stations/'>지하철역별 안내</a>가 편리합니다.</p>")],
     "faq": [
...
def build_magazine():
    ...
    for c in MAG_CATS:
        ...
        out += footer()
        write(f"/magazine/category/{c['slug']}/", out, priority="0.6")
